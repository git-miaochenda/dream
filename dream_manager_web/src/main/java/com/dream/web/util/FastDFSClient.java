...
public String uploadFile(String fileName, String extName,
    ...
    String result = storageClient.upload_file1(fileName, extName,
            metas);
    return result;
}
    ...
    public String uploadFile(String fileName, String extName) throws
            Exception {
    ...
    public String uploadFile(byte[] fileContent, String extName,
                             NameValuePair[] metas) throws Exception {
        String result = storageClient.upload_file1(fileContent, extName,
                metas);
        return result;
    }
