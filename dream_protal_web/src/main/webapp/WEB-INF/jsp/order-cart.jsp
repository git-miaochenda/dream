...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="苗少"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="19966667777"/>
	<input type="hidden" name="orderShipping.receiverState" value="安徽"/>
	<input type="hidden" name="orderShipping.receiverCity" value="安徽"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="合肥"/>
